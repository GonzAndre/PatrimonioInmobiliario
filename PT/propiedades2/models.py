...
class Post(models.Model):
    ...
    acquisition = models.ForeignKey(Acquisition, on_delete=models.CASCADE,blank=True, null=True, related_name='PostAcquisition')
    rent = models.ForeignKey(Rent, on_delete=models.CASCADE,blank=True, null=True, related_name='PostRent')
