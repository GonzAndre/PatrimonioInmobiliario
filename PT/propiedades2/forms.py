    ...
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Ingrese nombre de la propiedad', 'id': 'name','required': True}),
            'role_number': forms.NumberInput(
                attrs={'class': 'form-control', 'placeholder': 'Ingrese número de rol', 'id': 'role_number','required': True}),
            'image': forms.ClearableFileInput(
                attrs={'class': 'form-control', 'placeholder': 'Seleccione una imagen', 'id': 'image', 'type': 'file'}),
            'property_use': forms.Select(attrs={'class': 'form-control', 'id': 'property_use','required': True}),
            'district': forms.Select(attrs={'class': 'form-control', 'id': 'district','required': True}),
