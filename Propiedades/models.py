...
class Post(models.Model):
    ...
    publish_date = models.DateTimeField(default=timezone.now)
    property = models.OneToOneField(Property, on_delete=models.CASCADE, related_name='PostPropiedad')
...
class Acquisition(Property):
    ...
    domain_certificate = models.ForeignKey(Document, on_delete=models.CASCADE, blank=True, null=True, related_name='CertificadoDominio')
...
#tabla intermedia entre documento y propiedad

# class Doc_Acquisition(models.Model):
#     doc = models.OneToOneField(Document, on_delete=models.CASCADE)
#     prop = models.ForeignKey(Acquisition, on_delete=models.CASCADE, related_name='DocAcquisition')
#
#
# class Doc_Rent(models.Model):
#     doc = models.OneToOneField(Document, on_delete=models.CASCADE)
#     prop = models.ForeignKey(Rent, on_delete=models.CASCADE, related_name='DocRent')
