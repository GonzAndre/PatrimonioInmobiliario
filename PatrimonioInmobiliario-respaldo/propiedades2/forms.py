...
from propiedades2.models import Location, Acquisition, DocumentEx, DocumentCip, DocumentCn, DocumentBlue, \
    ...
    DocumentAc, DocumentEs, ArchitectureRecordAcq, InternalAccountantsAcq, NotaryAcquisition, SiiRecord, Rent, Post, Region, Property, Comment
...
class RegionForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ingrese el nombre de la región'}),
        }
...
class PostForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'description': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Escriba un comentario...'}),
        }
